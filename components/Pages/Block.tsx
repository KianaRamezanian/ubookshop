...
export const Block = props => {
    ...
    return <c-c style={{
        ...
        borderRadius:10,
        margin:" 10px",
        boxShadow:" 0px 0px 9px 2px rgba(0,0,0,0.31)"
    }}>
        ...
        <img
          ...
          <hr style={{width:"80%",opacity:0.2}}></hr>
            
            <f-csb style={{width:"100%" ,padding:"5px 0"}}>
               
               <img src ={props.state.cart.includes(props.book.title)?
               "https://cdn.ituring.ir/research/46/checkmark.png":
               "https://cdn.ituring.ir/research/46/social.png"} 
